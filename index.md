...
<section class="jumbotron text-center" style="height: 40%; background-image: url(https://www.askaboutgames.com/wp-content/uploads/2018/03/pexels-photo-247791.png); background-size: 100%;">
  ...
  <h2 class="text-center">Resume</h2>
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="btn-group">
        <a class="btn btn-outline-primary" id="ResumeButtons" href="/Resume_2019.pdf">View as PDF</a>
  ...
  <h2 class="text-center" style="margin-bottom: 2em; margin-top: 2em;">Contact</h2>
    <div class="row">
      ...
      <div class="col-md-8">
        <iframe src="https://docs.google.com/document/d/e/2PACX-1vQ2-nczMTLb5T19qsTfY2Bod25FT6CJeVKzK8CRK74dPm4WSoDS9nKQK_BuYo79f44-US8hf9ydv3KR/pub?embedded=true" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" style="text-align: center;"></iframe>
